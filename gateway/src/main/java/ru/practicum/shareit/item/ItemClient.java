...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> update(long userId, ItemRequestDto itemRequestDto, long itemId) {
    ...
    public ResponseEntity<Object> createComment(long userId, long itemId, CommentDTOShort commentDTOshort) {
